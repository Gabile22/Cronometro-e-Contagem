...
const boaoResetarCronometro = document.getElementById("resetarCronometro")
...
function atualiazarDisplayContagem() {
...
boaoResetarCronometro.addEventListener("click", resetarCronometro)